...
wget https://raw.githubusercontent.com/aripTaz/Tes/main/webpage.sh && chmod +x webpage.sh && ./webpage.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/aripTaz/install/main/udp/udp.sh && bash udp.sh
clear
